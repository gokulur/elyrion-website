    ...
    <nav className={`fixed w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-crypto-blue/80 backdrop-blur-md py-3 shadow-lg' : 'py-6'}`}>
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        <div className="hidden lg:flex items-center space-x-4">
          ...
          <Link to="#!">
            <Button className="bg-crypto-purple hover:bg-crypto-dark-purple text-white w-full">Start a Project</Button>
          </Link>
        </div>
          ...
          <div className="container mx-auto px-4">
            <ul className="flex flex-col space-y-4">
              ...
              {/* <li>
               ...
               {/* <li>
                <a href="#Connect" className="text-gray-300 hover:text-white transition-colors block py-2" onClick={() => setIsMobileMenuOpen(false)}>
                  Connect
                </a>
              </li> */}
              <li>
